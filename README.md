...
| 13                        | -                                                                                                                     | Cible avant / Cible arrière | L'autre cible             | Demande de si l'autre cible est connectée à un pistolet ou non *(si quand on rallume la cible, elle n'a pas de pistolet en mémoire, elle peut demander à l'autre cible si elle est déja connectée à un pistolet)*.
| 14                        | - 1SB: couleur **hue**<br/>- 2LSB(1/2): hasBeenConnected?<br/>- 2LSB(2/2): equipeChosen?                            | Cible avant / Cible arrière | L'autre cible             | **Réponse** à la demande si la cible a été connectée à un pistolet ***(id 13)***.
...
| 45                        | - 0: Plastrons allumés<br/>- 1: Plastrons éteints                                                                     | Pistolet                   | Cible avant / Cible arrière | Eteindre ou allumer la lumière des plastrons.                                                                                                                                                                                                                                                |
